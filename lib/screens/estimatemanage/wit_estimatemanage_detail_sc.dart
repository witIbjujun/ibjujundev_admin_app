      ...
      body: DefaultTabController(
        ...
        child: Column(
          children: [
            ...
            TabBar(
              tabs: [
                Tab(text: "견적 대기 (${widget.itemInfo["waitCnt"]})"),
                Tab(text: "견적 진행 (${widget.itemInfo["goingCnt"]})"),
                Tab(text: "견적 취소 (${widget.itemInfo["cencelCnt"]})"),
              ],
            ),
            Expanded(
              child: TabBarView(
